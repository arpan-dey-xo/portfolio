          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Worked across several projects showcasing problem-solving, development, and design skills. Built responsive and user-friendly applications using modern web technologies.</p>
